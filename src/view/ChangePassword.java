...
//        if (nameAccount.equals("") || passwordAccount.equals("")) {
//            JOptionPane.showMessageDialog(this, "Vui lòng nhập đầy đủ thông tin !");
//        } else {
//            if (isValid()) {
//                if (passwordAccount.equals(accCur.getPassword())) {
...
//        }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (check == true) {
            if (curPass.equals(accCur.getPassword())) {
                //BCrypt.hashpw(txtpassword.getText(), BCrypt.gensalt(12))
                if (newPass.length() < 3) {
                    JOptionPane.showMessageDialog(this, "Vui lòng nhập mật khẩu mới lớn bằng 3 kí tự");
                } else {
                    if (newPass.equals(newPassConf)) {
//                        String pass = BCrypt.hashpw(passAft.getText(), BCrypt.gensalt(12));
                        String pass = new String(passAft.getPassword());
