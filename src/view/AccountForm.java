...
//        }
        ...
        if (tblAccount.getSelectedRow() == -1) {
            ...
            int check = JOptionPane.showConfirmDialog(this, "Bạn có muốn reset tài khoản này ?", "Reset", JOptionPane.YES_NO_OPTION);
            if (check == JOptionPane.YES_OPTION) {
                String textct = JOptionPane.showInputDialog(this, "Nhập mật khẩu bạn muốn thay đổi: ");
                if (textct.equals("")) {
                    JOptionPane.showMessageDialog(this, "Không được để trống !");
                    ...
                    // Không mã hóa, lưu mật khẩu trực tiếp
                    accReset.setPassword(textct);
