...
public class AddAccount extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 450, 140, 38));
        ...
        jPanel1.add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 450, 140, 38));
...
//        }
        ...
        String password = txtpassword.getText().trim(); // Không mã hóa
        String role = vaitro.getSelectedItem().toString();
...
//        }
        ...
        Account acc = new Account(fullName, user, password, role, 1);
        // Thêm vào cơ sở dữ liệu
        AccountDAO.getInstance().insert(acc);
        // Load lại bảng dữ liệu và đóng form
        this.dispose();
        homeAcc.loadDataToTable(AccountDAO.getInstance().selectAll());
